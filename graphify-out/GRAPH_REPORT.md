# Graph Report - calebs-3d-case-study  (2026-05-11)

## Corpus Check
- 202 files · ~327,903 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1255 nodes · 2207 edges · 138 communities (108 shown, 30 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 115 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e12ba038`
...
Cohesion: 0.08
Nodes (42): aq(), b(), bD(), $C(), d(), d1(), dq(), E() (+34 more)
...
Cohesion: 0.1
Nodes (27): handleHeavyMotion(), handleVisibilityChange(), safeId(), isHeavyMotionActive(), delay(), getPhaseMessage(), isMobile(), prepareProjectEntry() (+19 more)
...
Cohesion: 0.12
Nodes (17): _build_worker(), classify_call_intent(), create_staff_task(), _entrypoint(), flag_for_review(), get_provider_availability(), log_patient_statement(), lookup_patient() (+9 more)

### Community 13 - "Community 13"
Cohesion: 0.14
Nodes (24): _medical_question_replay(), Summit Health Voice Agent — contract_replay.py Offline smoke test. No LiveKit re, Verify workers comp blocks scheduling and allows transfer., Verify medical question blocks scheduling and allows log_patient_statement., _run_replay(), _workers_comp_replay(), envelope(), intent_event() (+16 more)
...
Cohesion: 0.11
Nodes (23): ke(), df(), Ef(), EU(), ff(), fN(), hs(), If() (+15 more)

### Community 17 - "Community 17"
Cohesion: 0.1
Nodes (22): bL(), bS(), dS(), eL(), eM(), hL(), I1(), iP() (+14 more)
...
Cohesion: 0.14
Nodes (8): classify_intent_from_text(), create_workflow_state(), IntentClassification, Summit Health Voice Agent — workflow_state.py Deterministic call-state machine p, Deterministic keyword-based classifier mirroring classifySummitIntentFromText., SummitAppointmentDraft, SummitIdentityCapture, SummitWorkflowState
...
Cohesion: 0.15
Nodes (5): _make_slots(), MockEcwAdapter, Summit Health Voice Agent — mock_ecw.py Fake eClinicalWorks adapter. No real net, Returns one or two providers depending on scenario., Always returns staff_review_only — never a real EHR write.

### Community 23 - "Community 23"
Cohesion: 0.12
Nodes (12): Agent, _LKAgent, decode_control_packet(), Summit Health Voice Agent — event_bus.py Publishes SummitDemoEvent envelopes to, Wraps a LiveKit room to publish SummitDemoEvent envelopes and     receive summit, Serialize an event into the envelope format and publish to the room., Parse a raw data packet from the frontend.     Accepts three shapes:       1. {, Parse a raw data packet from the frontend.     Accepts three shapes:       1. { (+4 more)
...
Cohesion: 0.42
Nodes (9): _clarify(), evaluate_policy(), _pass(), PolicyResult, Summit Health Voice Agent — policy_gate.py Deterministic Python port of src/lib/, Evaluate whether a tool call is allowed given the current workflow state.     Th, _reject(), _review() (+1 more)

### Community 30 - "Community 30"
Cohesion: 0.2
Nodes (10): di(), dx(), fx(), gx(), lx(), Oa(), px(), Sa() (+2 more)

### Community 31 - "Community 31"
Cohesion: 0.25
Nodes (4): load_config(), Summit Health Voice Agent — config.py Loads environment variables from .env.loca, Build a SummitAgentConfig from the current environment., SummitAgentConfig
...
Cohesion: 0.31
Nodes (5): ManagedHeroVideo(), Kicker(), MetricTile(), SignalCard(), SystemCard()
...
## Knowledge Gaps
- **48 isolated node(s):** `Summit Health Voice Agent — agent.py LiveKit Agents 1.x worker entrypoint.  Run:`, `Per-session state and tool/policy/event pipeline.`, `Deterministic keyword-based fallback for weak tool calling.`, `Classify the caller's intent from their first statement.`, `Look up a patient by name and date of birth.` (+43 more)
...
- **Why does `ManagedHeroVideo()` connect `Community 33` to `Community 35`, `Community 37`, `Community 38`, `Community 39`, `Community 8`, `Community 40`, `Community 10`, `Community 41`, `Community 7`, `Community 45`, `Community 46`, `Community 44`, `Community 43`, `Community 42`, `Community 5`, `Community 27`?**
  _High betweenness centrality (0.140) - this node is a cross-community bridge._
- **Why does `createHeavyMotionSettler()` connect `Community 8` to `Community 15`?**
  _High betweenness centrality (0.136) - this node is a cross-community bridge._
- **Why does `onReady()` connect `Community 15` to `Community 16`?**
...
- **What connects `Summit Health Voice Agent — agent.py LiveKit Agents 1.x worker entrypoint.  Run:`, `Per-session state and tool/policy/event pipeline.`, `Deterministic keyword-based fallback for weak tool calling.` to the rest of the system?**
